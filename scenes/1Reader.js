...
bot.hears('Аль-Афаси (مشاري العفاسي)', async (ctx) => {
	await ctx.reply('Отлично, ты выбрал Аль-Афаси (مشاري العفاسي), ты в любой момент можешь сменить написав команду /change_reader \nНу а теперь выбери выбери суру', sura.reply())
})
