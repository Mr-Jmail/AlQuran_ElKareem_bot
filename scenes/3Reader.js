...
bot.hears(s34, async (ctx) => ctx.replyWithAudio('CQACAgIAAxkBAAIC8GJI1aUAAVXKFXnjs84J5RRTZVgmaQACZRYAAsLTSUq_ryooReFCQSME","file_unique_id":"AgADZRYAAsLTSUo'))

bot.hears(s35, async (ctx) => ctx.replyWithAudio('CQACAgIAAxkBAAIC8WJI1azz7J4VgibesNzPa80EcLMQAAJmFgACwtNJSgn53OBilkxHIwQ","file_unique_id":"AgADZhYAAsLTSUo'))

bot.hears(s36, async (ctx) => ctx.replyWithAudio('CQACAgIAAxkBAAIC8mJI1bIFfQI_RPCPcauZE5tK7ALAAAJnFgACwtNJSvP87ShZ2eNPIwQ","file_unique_id":"AgADZxYAAsLTSUo'))
